      ...
      <div className="w-full px-4 md:px-16 lg:px-24 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="bg-white rounded-[24px] md:rounded-[32px] p-6 md:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-1.5 transition-all duration-300 group flex flex-col cursor-default">
            ...
            <h3 className="text-base font-semibold text-slate-800 mb-1">Daily Mental Check-in</h3>
            ...
            <div className="mt-auto flex flex-col gap-3">
              <div className="bg-slate-50 border border-slate-100 rounded-xl p-4 flex justify-between items-center group-hover:border-primary-100 transition-colors">
                <span className="text-xs sm:text-sm text-slate-500">Bagaimana mood-mu hari ini?</span>
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-xl p-4 flex justify-between items-center group-hover:border-primary-100 transition-colors delay-75">
                <span className="text-xs sm:text-sm text-slate-500">Kualitas tidur semalam?</span>
                <ArrowRight size={16} className="text-primary-400 group-hover:translate-x-1 transition-transform" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[24px] md:rounded-[32px] p-6 md:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-1.5 transition-all duration-300 group flex flex-col cursor-default">
            ...
            <h3 className="text-base font-semibold text-slate-800 mb-1">AI Burnout Detection</h3>
            <p className="text-xs text-slate-500 leading-relaxed mb-6">
          ...
          <div className="bg-white rounded-[24px] md:rounded-[32px] p-6 md:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-1.5 transition-all duration-300 group flex flex-col cursor-default">
            ...
            <h3 className="text-base font-semibold text-slate-800 mb-1">Personalized AI Insight</h3>
            <p className="text-xs text-slate-500 leading-relaxed mb-6">
            ...
            <div className="mt-auto bg-slate-50 border border-slate-100 rounded-xl p-5 relative group-hover:border-primary-100 transition-colors">
              <div className="absolute -left-1 -top-3 text-4xl text-primary-200 font-serif leading-none opacity-0 group-hover:opacity-100 group-hover:-top-5 transition-all duration-300">"</div>
          ...
          <div className="bg-white rounded-[24px] md:rounded-[32px] p-6 md:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-1.5 transition-all duration-300 group flex flex-col cursor-default">
            ...
            <h3 className="text-base font-semibold text-slate-800 mb-1">Smart Recovery To-Do</h3>
            <p className="text-xs text-slate-500 leading-relaxed mb-6">
            ...
            <div className="mt-auto bg-slate-50 border border-slate-100 rounded-xl p-5 flex flex-col gap-3.5">
              <div className="flex items-center gap-2.5 text-xs sm:text-sm text-slate-500">
                <CheckCircle2 size={16} className="text-primary-500 shrink-0 group-hover:scale-110 transition-transform" />
                <span className="line-through text-slate-400">Tidur lebih awal</span>
              </div>
              <div className="flex items-center gap-2.5 text-xs sm:text-sm text-slate-500">
                <Circle size={16} className="text-slate-300 shrink-0 group-hover:text-primary-400 transition-colors delay-75" />
                <span>Jalan kaki 15 menit</span>
              </div>
              <div className="flex items-center gap-2.5 text-xs sm:text-sm text-slate-500">
                <Circle size={16} className="text-slate-300 shrink-0 group-hover:text-primary-400 transition-colors delay-100" />
          ...
          <div className="bg-white rounded-[24px] md:rounded-[32px] p-6 md:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-1.5 transition-all duration-300 group flex flex-col cursor-default">
            ...
            <h3 className="text-base font-semibold text-slate-800 mb-1">Progress Tracking</h3>
            <p className="text-xs text-slate-500 leading-relaxed mb-6">
            ...
            <div className="mt-auto bg-slate-50 border border-slate-100 rounded-xl h-28 relative overflow-hidden group-hover:border-primary-200 transition-colors">
              ...
              <div className="absolute top-3 left-4 right-4 flex justify-between items-center z-10">
                <span className="text-[11px] font-semibold text-slate-500">Tren 7 Hari</span>
                <span className="text-[10px] font-bold px-2 py-1 rounded flex items-center gap-1 bg-emerald-100 text-emerald-700 leading-none">
                  ...
                  <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 17 13.5 8.5 8.5 13.5 2 7"></polyline><polyline points="16 17 22 17 22 11"></polyline></svg>
                  Membaik
                </span>
              </div>
          ...
          <div className="bg-white rounded-[24px] md:rounded-[32px] p-6 md:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-1.5 transition-all duration-300 group flex flex-col cursor-default">
            ...
            <h3 className="text-base font-semibold text-slate-800 mb-1">Admin Monitoring Dashboard</h3>
            <p className="text-xs text-slate-500 leading-relaxed mb-6">
